...
Network <- R6Class( classname = 'Network', cloneable = FALSE,
  ...
  public = list(
    ...
    {
      private$c_network <- get_network_by_id( c_model, network_id )
    ...
    n_edges = function() {
      return(network_n_edges( private$c_network ))
    },

    #' @description Wrapper for C API \code{network_n_vertices}.
    #' @return Number of vertices
    n_vertices = function() {
      return(network_n_vertices( private$c_network ))
    },

    #' @description Wrapper for C API \code{network_name}.
    #' @return The network name
    name = function() {
      return(network_name( private$c_network ))
    },
    ...
    skip_hospitalised = function() {
      return(network_skip_hospitalised( private$c_network ))
    },
