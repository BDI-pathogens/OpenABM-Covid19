...
class TestParameters(object):
    ...
    def test_set_parameters_arrays_set_single_value(self):
        p = Parameters(input_household_file="notset.csv", read_param_file=False)
        assert p.get_param("population_group_40_49") == 0, "Array memebers not intilialised to zero"
        p.set_param("population_group_40_49", 400)
        assert p.get_param("population_group_40_49") == 400, "Did not set pop group to 400"
