...
#------------------------------------------------------------------------------
R_SRC= $(SWIG_ROUT) R/util.R R/Model.R R/Parameters.R R/Network.R
ROXYGEN_OUT = man/Parameters.Rd man/Model.Rd man/AgeGroupEnum.Rd \
  man/SAFE_UPDATE_PARAMS.Rd man/NETWORK_CONSTRUCTIONS.Rd man/Network.Rd
